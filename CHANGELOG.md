...
- Canonicalized Docker and Podman OCI image identities in all seven public
  conformance runners while retaining exact repository, manifest-digest,
  config-digest, and platform checks.
