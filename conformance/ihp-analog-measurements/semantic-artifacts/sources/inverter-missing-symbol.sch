...
C {vsource.sym} 150 -110 0 0 {name=V1 value="PULSE(0 1.2 0.5u 10n 10n 0.98u 2u)" savecurrent=false}
...
.control
save all
tran 31.25n 32.46875u 0.5u
linearize
write inverter_spectral.raw
.endc
" }
...
C {__openada_measurement_missing__.sym} 620 -100 0 0 {name=x_openada_measurement_missing}
