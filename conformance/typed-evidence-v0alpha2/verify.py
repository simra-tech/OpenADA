...
MEASUREMENT_FEATURES = (
    ...
    "openada.feature/measurement.slope/v1alpha1",
)
...
def load_manifest(path: Path = DEFAULT_MANIFEST) -> dict[str, Any]:
    ...
    _expect(manifest["id"], "typed-evidence-measurement-specification-v0alpha2", "manifest.id")
    _expect(
...
def _verify_common_result(
    ...
    *,
    ...
    _expect(protocol["implementation_version"], implementation_version, f"{location}.protocol.implementation_version")
